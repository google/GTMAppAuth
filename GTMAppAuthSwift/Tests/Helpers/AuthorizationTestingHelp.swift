...
class AuthorizationTestingHelper: GTMAppAuthFetcherAuthorization {
  override func authorizeRequest(
...
class AuthorizationTestDelegate: NSObject {
  ...
  /// - parameter authorization: The `GTMAppAuthFetcherAuthorization` authorizing
  /// the request.
  /// - parameter request: The request to be authorized.
  /// - parameter error: The `NSError?` should one arise during authorization.
